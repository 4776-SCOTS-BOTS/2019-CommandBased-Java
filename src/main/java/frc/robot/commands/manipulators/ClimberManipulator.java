...
/**
 * From <b>STATES</b>.
 * <p>During TeleOp, run this command for climbing capability. Please remember, <b>FRONT=BEAK/BATTERY, REAR=JAW/CARGO</b>
 */
  ...
  */
  ...
  protected void execute() {
    ...
    if (useScale){
      if (style!=ClimbStyle.Joystick){
        ...
        *///#endregion
        ...
        if (joystickInput) {
          ...
          //rrSpeed = (rrTouchingTheGround)? basicSpeed: (1 - Math.pow(2*Robot.climber.getRearRightPot(true), rampAffect));
      ...
      double pot = Robot.climber.getFrontLeftPot(false);
      fl = 0;
    }
