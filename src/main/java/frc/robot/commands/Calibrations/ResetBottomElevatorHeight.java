...
public class ResetBottomElevatorHeight extends Command {
  ...
  public ResetBottomElevatorHeight(RobotMap.RobotName robot) {
    myRobot = robot;
  }
  ...
  protected void initialize() {
    switch(myRobot) {
      ...
      break;
      default: {
        System.out.println(myRobot + " has no case in \'ResetBottomElevatorHeight\'!");
        RobotMap.CompBot.HIGH_HEIGHT = Robot.elevator.getRightPot();
      }
    }
    System.out.println("The bottom elevator height for the " + myRobot + " has been set to " + Robot.elevator.getRightPot() + ".");
  }
