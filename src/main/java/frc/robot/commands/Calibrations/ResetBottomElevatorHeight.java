...
public class ResetBottomElevatorHeight extends Command {
  public ResetBottomElevatorHeight() {
  }

  // Called just before this Command runs the first time
  @Override
  protected void initialize() {
    RobotMap.PracticeBot.LOW_HEIGHT = Robot.elevator.getRightPot();
    System.out.println("The bottom elevator height for the PracticeBot has been set to " + RobotMap.PracticeBot.LOW_HEIGHT + ".");
  }
